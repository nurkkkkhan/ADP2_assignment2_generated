...
func (c *orderTrackingServiceClient) SubscribeToOrderUpdates(ctx context.Context, in *OrderSubscriptionRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OrderStatusUpdate], error) {
...
func (UnimplementedOrderTrackingServiceServer) SubscribeToOrderUpdates(*OrderSubscriptionRequest, grpc.ServerStreamingServer[OrderStatusUpdate]) error {
...
func _OrderTrackingService_SubscribeToOrderUpdates_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OrderTrackingServiceServer).SubscribeToOrderUpdates(m, &grpc.GenericServerStream[OrderSubscriptionRequest, OrderStatusUpdate]{ServerStream: stream})
}
